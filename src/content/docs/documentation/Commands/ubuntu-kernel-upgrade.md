---
title: "ubuntu kernel upgrade"
description: Bash script for Ubuntu (and derivatives as LinuxMint) to easily (un)install
  kernels from the Ubuntu Kernel PPA (http://kernel.ubuntu.com/~kernel-ppa/mainline/)
---
